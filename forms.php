...
$options = get_option('redirection_reporting');
	...
	function end_of_form($ShowHideForm) {
		...
		if (isset($_POST['Normal'])) {
			...
			$hide_rollup = isset($_POST['hide_rollup']) ? $_POST['hide_rollup'] : '';
		} elseif (isset($_GET['Normal'])) {
			$Normal = $_GET['Normal'];
			$url = isset($_GET['url']) ? $_GET['url'] : '';
			$startdate = isset($_GET['startdate']) ? $_GET['startdate'] : '';
			$enddate = isset($_GET['enddate']) ? $_GET['enddate'] : '';
			$hide_rollup = isset($_GET['hide_rollup']) ? $_GET['hide_rollup'] : '';
		}
	...
	function get_default_date(&$startdate, &$enddate) {
		...
		if (!isset($options['default_date']) || $options['default_date'] == 'None' || $options['default_date'] == "") {
			return;
		}
